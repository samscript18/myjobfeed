...
const HomePage = () => {
  ...
  return (
    <Layout>
      <section className="relative overflow-hidden py-24 lg:py-32 -mx-12 max-md:-mx-4">
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg text-muted-foreground md:text-xl">
                Discover thousands of opportunities from country&#39;s top companies. Start your career journey today.
              </p>
              ...
              <form onSubmit={handleSearch} className="mt-10">
                <div className="flex flex-col gap-3 sm:flex-row rounded-xl bg-card border border-border/50 p-2 shadow-lg sm:shadow-xl hover:shadow-xl transition-shadow">
                  ...
                  <Button type="submit" size="lg" className="h-12 bg-linear-to-r from-primary to-primary/90 text-white hover:shadow-lg transition-all font-semibold px-8 rounded-lg">
                    Search
                  </Button>
                </div>
              </form>
